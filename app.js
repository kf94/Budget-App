...
var UIController = (function () {
  ...
  var formatNumber = function (num,type) {
    ...
    //add necessary commas to integer
    if (int.length > 3) {
      var revArr, comArr = [];
      revArr = int.split("").reverse();
      for (let i = 0; i < revArr.length; i++) {
        if (i % 3 === 0) {
          comArr.unshift(',');
        };
        comArr.unshift(revArr[i]);
      };
      int = comArr.join("").slice(0,-1);
    };
  ...
  return {
    ...
    clearFields: function() {
      ...
      fieldsArr = [
        document.getElementsByClassName(DOMstrings.inputDescription)[0],
        document.getElementsByClassName(DOMstrings.inputValue)[0]
      ];
    ...
    displayBudget: function(obj) {
      ...
      document.getElementsByClassName(DOMstrings.expensesLabel)[0].textContent = formatNumber(obj.totalExp, 'exp');
    ...
    displayPercentages: function(percentages) {
      ...
      var fields = document.getElementsByClassName(DOMstrings.expensesPercentageLabel);
    ...
    displayMonth: function () {
      ...
      document.getElementsByClassName(DOMstrings.dateLabel)[0].textContent = month + ' ' + year;
    },

    changedType: function() {
      var fields = [
        document.getElementsByClassName(DOMstrings.inputType)[0],
        document.getElementsByClassName(DOMstrings.inputDescription)[0],
        document.getElementsByClassName(DOMstrings.inputValue)[0]
      ];
      ...
      document.getElementsByClassName(DOMstrings.inputButton)[0].classList.toggle('red');
...
var controller = (function (budgetCtrl, UICtrl) {
  ...
  var setUpEventListeners = function () {
    ...
    document.getElementsByClassName(DOM.inputButton)[0].addEventListener('click', ctrlAddItem);
    ...
    document.getElementsByClassName(DOM.inputType)[0].addEventListener('change',UICtrl.changedType);
  ...
  var updatePercentages = function() {
    ...
    //3.update UI w the new percentages
  ...
  var ctrlAddItem = function() {
    ...
    if (inputs.description !== "" && !isNaN(inputs.value) && inputs.value > 0) {
          ...
          //6.calc and update updatePercentages
          updatePercentages();
    }
  ...
  var ctrlDeleteItem = function(e) {
    ...
    if (itemID) {
      ...
      //4.calc and update updatePercentages
      updatePercentages();
